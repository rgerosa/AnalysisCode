...
config.General.workArea     = 'crab_projects_MC_TnP_80X'  # Make sure you set this parameter
...
config.Data.outLFNDirBase = '/store/group/phys_exotica/monojet/rgerosa/Production-12-07-2016_80X_TagAndProbe_MC/'
