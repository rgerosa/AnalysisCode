...
config.General.workArea     = 'crab_projects_DATA_80X_jetHT'  # Make sure you set this parameter
...
config.Data.outLFNDirBase = '/store/group/phys_exotica/monojet/rgerosa/ProductionData_30_08_2016_21p8fb_jetHT/'
