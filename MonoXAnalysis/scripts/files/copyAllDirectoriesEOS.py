...
if __name__ == '__main__':
    ...
    for dir in dirList:
        if options.toEOS:
          ...
          os.system('xrdcp -r -f -S '+str(options.nStreams)+' '+options.inputDIR+"/"+dir+' root://eoscms.cern.ch//eos/cms'+options.outputDIR+"/"+dir);        
        else:
          os.system("mkdir -p "+options.outputDIR+"/"+dir);
          os.system('xrdcp -r -f -S '+str(options.nStreams)+' root://eoscms.cern.ch//eos/cms'+options.inputDIR+"/"+dir+' '+options.outputDIR+"/"+dir);
