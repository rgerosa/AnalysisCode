...
if __name__ == '__main__':
    ...
    print dirList
    for dir in dirList:
        command = "python scripts/ntuples_reduction/runFiltersQCD.py --inputDIR "+options.inputDIR+"/"+dir+" --outputDIR "+options.outputDIR+" --jobDIR "+options.jobDIR+" --queque "+options.queque+" --batchMode --submit --isOnEOS ";
