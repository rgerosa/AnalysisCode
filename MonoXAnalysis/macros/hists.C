...
void sigdatamchist(TFile* outfile, string kFactorFile, int category, 		   
  ...
  if(interaction == "Vector"){
    for(size_t iPoint = 0; iPoint < massPoint.size(); iPoint++){
      monoJfile .push_back(TFile::Open(("/home/rgerosa/MONOJET_ANALYSIS/Production-24-1-2016/DMV_Vector/sigfilter/sig_tree_DMV_NNPDF30_Vector_Mphi-"+massPoint.at(iPoint).first+"_Mchi-"+massPoint.at(iPoint).second+"_gSM-1p0_gDM-1p0_13TeV-powheg.root").c_str()));
      monoWfile .push_back(TFile::Open(("/home/rgerosa/MONOJET_ANALYSIS/Production-24-1-2016/MonoW_Vector/sigfilter/sig_tree_VectorMonoW_Mphi-"+massPoint.at(iPoint).first+"_Mchi-"+massPoint.at(iPoint).second+"_gSM-1p0_gDM-1p0_13TeV-madgraph.root").c_str()));
      monoZfile .push_back(TFile::Open(("/home/rgerosa/MONOJET_ANALYSIS/Production-24-1-2016/MonoZ_Vector/sigfilter/sig_tree_VectorMonoZ_Mphi-"+massPoint.at(iPoint).first+"_Mchi-"+massPoint.at(iPoint).second+"_gSM-1p0_gDM-1p0_13TeV-madgraph.root").c_str()));
    }
  }

  else if(interaction == "Axial"){
    for(size_t iPoint = 0; iPoint < massPoint.size(); iPoint++){
      monoJfile .push_back(TFile::Open(("/home/rgerosa/MONOJET_ANALYSIS/Production-24-1-2016/DMV_Axial/sigfilter/sig_tree_DMV_NNPDF30_Axial_Mphi-"+massPoint.at(iPoint).first+"_Mchi-"+massPoint.at(iPoint).second+"_gSM-1p0_gDM-1p0_13TeV-powheg.root").c_str()));
      monoWfile .push_back(TFile::Open(("/home/rgerosa/MONOJET_ANALYSIS/Production-24-1-2016/MonoW_Axial/sigfilter/sig_tree_AxialMonoW_Mphi-"+massPoint.at(iPoint).first+"_Mchi-"+massPoint.at(iPoint).second+"_gSM-1p0_gDM-1p0_13TeV-madgraph.root").c_str()));
      monoZfile .push_back(TFile::Open(("/home/rgerosa/MONOJET_ANALYSIS/Production-24-1-2016/MonoZ_Axial/sigfilter/sig_tree_AxialMonoZ_Mphi-"+massPoint.at(iPoint).first+"_Mchi-"+massPoint.at(iPoint).second+"_gSM-1p0_gDM-1p0_13TeV-madgraph.root").c_str()));
    }
  }
  else if(interaction == "Scalar"){
    for(size_t iPoint = 0; iPoint < massPoint.size(); iPoint++){
      monoJfile .push_back(TFile::Open(("/home/rgerosa/MONOJET_ANALYSIS/Production-24-1-2016/DMS_Scalar/sigfilter/sig_tree_DMS_NNPDF30_Scalar_Mphi-"+massPoint.at(iPoint).first+"_Mchi-"+massPoint.at(iPoint).second+"_gSM-1p0_gDM-1p0_13TeV-powheg.root").c_str()));
      monoWfile .push_back(TFile::Open(("/home/rgerosa/MONOJET_ANALYSIS/Production-24-1-2016/MonoW_Scalar/sigfilter/sig_tree_DM_ScalarWH_Mphi-"+massPoint.at(iPoint).first+"_Mchi-"+massPoint.at(iPoint).second+"_gSM-1p0_gDM-1p0_13TeV-JHUGen.root").c_str()));
    }
  }
  else if(interaction == "Pseudoscalar"){
    for(size_t iPoint = 0; iPoint < massPoint.size(); iPoint++){
      monoJfile .push_back(TFile::Open(("/home/rgerosa/MONOJET_ANALYSIS/Production-24-1-2016/DMS_Pseudoscalar/sigfilter/sig_tree_DMS_NNPDF30_Pseudoscalar_Mphi-"+massPoint.at(iPoint).first+"_Mchi-"+massPoint.at(iPoint).second+"_gSM-1p0_gDM-1p0_13TeV-powheg.root").c_str()));
      monoWfile .push_back(TFile::Open(("/home/rgerosa/MONOJET_ANALYSIS/Production-24-1-2016/MonoW_Pseudoscalar/sigfilter/sig_tree_DM_PseudoscalarWH_Mphi-"+massPoint.at(iPoint).first+"_Mchi-"+massPoint.at(iPoint).second+"_gSM-1p0_gDM-1p0_13TeV-JHUGen.root").c_str()));
      monoZfile .push_back(TFile::Open(("/home/rgerosa/MONOJET_ANALYSIS/Production-24-1-2016/MonoZ_Pseudoscalar/sigfilter/sig_tree_DM_PseudoscalarZH_Mphi-"+massPoint.at(iPoint).first+"_Mchi-"+massPoint.at(iPoint).second+"_gSM-1p0_gDM-1p0_13TeV-JHUGen.root").c_str()));
    }
  }
