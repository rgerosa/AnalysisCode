...
void plot1D(TCanvas* canvas, TH1* histo, string name, string outputDIR, bool text = false){
...
void makeEfficiencyComparison(string namefile1, string namefile2, string outputDIR, bool reweight = true, bool useOnlyCommonPoints = false, float minMedMass = 0){
  ...
  vector<float> recoilBin_1D = {200,300,400,500,650,1000};
  

  TH2F* mediator1_D_2D = new TH2F("mediator1_D_2D","",50,0,1000,50,0,1000);
  TH2F* mediator2_D_2D = new TH2F("mediator2_D_2D","",50,0,1000,50,0,1000);
  mediator1_D_2D->Sumw2();
  mediator2_D_2D->Sumw2();

  TH1F* mediator1_D_1D = new TH1F("mediator1_D_1D","",150,0,1000);
  TH1F* mediator2_D_1D = new TH1F("mediator2_D_1D","",150,0,1000);
  mediator1_D_1D->Sumw2();
  mediator2_D_1D->Sumw2();

  if(reweight){
    tree1->Draw("genMediatorPt:pfMetPt >> mediator1_D_2D","(genWeight*weight)*(genMediatorPt > 0)","goff");
    tree2->Draw("genMediatorPt:pfMetPt >> mediator2_D_2D","(genWeight*weight)*(genMediatorPt > 0)","goff");
    tree1->Draw("pfMetPt >> mediator1_D_1D","(genWeight*weight)*(genMediatorPt > 0)","goff");
    tree2->Draw("pfMetPt >> mediator2_D_1D","(genWeight*weight)*(genMediatorPt > 0)","goff");    
  }
  ...
  TH2F* mediator1_N_2D = new TH2F("mediator1_N_2D","",50,0,1000,50,0,1000);
  TH2F* mediator2_N_2D = new TH2F("mediator2_N_2D","",50,0,1000,50,0,1000);
  ...
  mediator1_D_2D->Divide(mediator1_N_2D);
  ...
  mediator2_D_2D->Divide(mediator2_N_2D);


  TH1F* mediator1_N_1D = new TH1F("mediator1_N_1D","",150,0,1000);
  TH1F* mediator2_N_1D = new TH1F("mediator2_N_1D","",150,0,1000);
  mediator1_N_1D->Sumw2();
  mediator2_N_1D->Sumw2();
  
  for(int iBinX = 0; iBinX < mediator1_N_1D->GetNbinsX()+1; iBinX++){
    for(int iBinY = 0; iBinY < mediator1_N_1D->GetNbinsY()+1; iBinY++){
      mediator1_N_1D->SetBinContent(iBinX+1,iBinY+1,1);
    }
  }
  mediator1_N_1D->Scale(1./mediator1_N_1D->Integral());
  mediator1_D_1D->Divide(mediator1_N_1D);
  
  for(int iBinX = 0; iBinX < mediator1_N_1D->GetNbinsX()+1; iBinX++){
    for(int iBinY = 0; iBinY < mediator1_N_1D->GetNbinsY()+1; iBinY++){
      mediator2_N_1D->SetBinContent(iBinX+1,iBinY+1,1);
    }
  }
  mediator2_N_1D->Scale(1./mediator2_N_1D->Integral());
  mediator2_D_1D->Divide(mediator2_N_1D);

  // use them as event weight
  TH2F* mediator1_w_2D = new TH2F("mediator1_w_2D","",50,0,1000,50,0,1000);
  TH2F* mediator2_w_2D = new TH2F("mediator2_w_2D","",50,0,1000,50,0,1000);
  mediator1_w_2D->Sumw2();
  mediator2_w_2D->Sumw2();

  TH1F* mediator1_w_1D = new TH1F("mediator1_w_1D","",150,0,1000);
  TH1F* mediator2_w_1D = new TH1F("mediator2_w_1D","",150,0,1000);
  ...
  while(reader1.Next()){
    ...
    if(reweight){
      mediator1_w_1D->Fill(*recoilPt1,1./mediator1_D_1D->GetBinContent(mediator1_D_1D->FindBin(*recoilPt1))*(*weight1)*(*genweight1));
      mediator1_w_2D->Fill(*recoilPt1,*genMediatorPt1,1./mediator1_D_2D->GetBinContent(mediator1_D_2D->FindBin(*recoilPt1,*genMediatorPt1))*(*weight1)*(*genweight1));
    }

    if(reweight){
      mediator1_weighted_1D->Fill(*recoilPt1,1./mediator1_D_1D->GetBinContent(mediator1_D_1D->FindBin(*recoilPt1))*(*weight1)*(*genweight1));
      mediator1_weighted_2D->Fill(*recoilPt1,*genMediatorPt1,1./mediator1_D_2D->GetBinContent(mediator1_D_2D->FindBin(*recoilPt1,*genMediatorPt1))*(*weight1)*(*genweight1));
      if(*id1 == 1){
	mediator1_weighted_1D_id1->Fill(*recoilPt1,1./mediator1_D_1D->GetBinContent(mediator1_D_1D->FindBin(*recoilPt1))*(*weight1)*(*genweight1));
	mediator1_weighted_id1->Fill(*recoilPt1,*genMediatorPt1,1./mediator1_D_2D->GetBinContent(mediator1_D_2D->FindBin(*recoilPt1,*genMediatorPt1))*(*weight1)*(*genweight1));
      }
      if(*id1 == 2){
	mediator1_weighted_1D_id2->Fill(*recoilPt1,1./mediator1_D_1D->GetBinContent(mediator1_D_1D->FindBin(*recoilPt1))*(*weight1)*(*genweight1));    
	mediator1_weighted_id2->Fill(*recoilPt1,*genMediatorPt1,1./mediator1_D_2D->GetBinContent(mediator1_D_2D->FindBin(*recoilPt1,*genMediatorPt1))*(*weight1)*(*genweight1));
      }
    }
    else{
  ...
  while(reader2.Next()){
    ...
    if(reweight){
      mediator2_w_1D->Fill(*recoilPt2,1./mediator2_D_1D->GetBinContent(mediator2_D_1D->FindBin(*recoilPt2))*(*weight2)*(*genweight2));
      mediator2_w_2D->Fill(*recoilPt2,*genMediatorPt2,1./mediator2_D_2D->GetBinContent(mediator2_D_2D->FindBin(*recoilPt2,*genMediatorPt2))*(*weight2)*(*genweight2));
    }
    if(reweight){
      mediator2_weighted_1D->Fill(*recoilPt2,1./mediator2_D_1D->GetBinContent(mediator2_D_1D->FindBin(*recoilPt2))*(*weight2)*(*genweight2));
      mediator2_weighted_2D->Fill(*recoilPt2,*genMediatorPt2,1./mediator2_D_2D->GetBinContent(mediator2_D_2D->FindBin(*recoilPt2,*genMediatorPt2))*(*weight2)*(*genweight2));
    
      if(*id2 == 1){
	mediator2_weighted_1D_id1->Fill(*recoilPt2,1./mediator2_D_1D->GetBinContent(mediator2_D_1D->FindBin(*recoilPt2))*(*weight2)*(*genweight2));
	mediator2_weighted_id1->Fill(*recoilPt2,*genMediatorPt2,1./mediator2_D_2D->GetBinContent(mediator2_D_2D->FindBin(*recoilPt2,*genMediatorPt2))*(*weight2)*(*genweight2));
      }
      if(*id2 == 2){
	mediator2_weighted_1D_id2->Fill(*recoilPt2,1./mediator2_D_1D->GetBinContent(mediator2_D_1D->FindBin(*recoilPt2))*(*weight2)*(*genweight2));
	mediator2_weighted_id2->Fill(*recoilPt2,*genMediatorPt2,1./mediator2_D_2D->GetBinContent(mediator2_D_2D->FindBin(*recoilPt2,*genMediatorPt2))*(*weight2)*(*genweight2));
      }
    }
    else{
  ...
  printBin(mediator1_weighted_1D);
  printBin(mediator1_weighted_1D_id1);
  printBin(mediator1_weighted_1D_id2);
  printBin(mediator2_weighted_1D);
  printBin(mediator2_weighted_1D_id1);
  printBin(mediator2_weighted_1D_id2);
