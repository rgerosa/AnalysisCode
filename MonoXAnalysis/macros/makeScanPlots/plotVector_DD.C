//https://gitlab.cern.ch/CMSExoMetxCombo/MetxCombo2016/blob/master/DD/SI/LUX_SI_Combination_Oct2016.txt
...
double vecF(double mMED,double mDM){
    ...
    //(c*(9./3.14159)*(mR*mR/(mMED*mMED*mMED*mMED)));
}
...
void plotVectorDD() {
    ...
    TString energy = "13";
    TFile *file = new TFile("/afs/cern.ch/user/r/rgerosa/public/xZeynep/Scans8April/higgsCombine_COMB_Vector_DD.root");
    ...
    /*
    TH2* hexp = grexp->GetHistogram();
    TH2* hobs = grobs->GetHistogram();
    */
    ...
    TLegend *leg = new TLegend(0.22,0.62,0.80,0.84,NULL,"brNDC");
    //leg->AddEntry(gr8e     ,"Median Expected (8 TeV) 90% CL","L");
    leg->AddEntry(DDE_graph,"CMS median exp. 90% CL","L");
    ...
    tex->DrawLatex(0.22,0.86,"#bf{Vector med, Dirac DM,  g_{q} = 0.25, g_{DM} = 1}");
    
    canvas->SaveAs("/afs/cern.ch/user/z/zdemirag/www/Monojet/moriond_80x/unblinding_march26/test_monojetv2/fits/scanDD_vector_g"+coupling+"_"+energy+"TeV_v1.pdf");
    canvas->SaveAs("/afs/cern.ch/user/z/zdemirag/www/Monojet/moriond_80x/unblinding_march26/test_monojetv2/fits/scanDD_vector_g"+coupling+"_"+energy+"TeV_v1.png");
    canvas->SaveAs("/afs/cern.ch/user/z/zdemirag/www/Monojet/moriond_80x/unblinding_march26/test_monojetv2/fits/scanDD_vector_g"+coupling+"_"+energy+"TeV_v1.C");

    TFile*outfile = new TFile("vector_g"+coupling+"_DD.root","RECREATE");
