...
void plotScalar_1D(string inputFileName, string outputDIR, int dmMass = 1, string coupling = "025") {
  ...
  canvas->SaveAs((outputDIR+"/scan_scalar_1D_dmMass_"+to_string(dmMass)+"_g"+string(coupling)+".pdf").c_str(),"pdf");
  canvas->SaveAs((outputDIR+"/scan_scalar_1D_dmMass_"+to_string(dmMass)+"_g"+string(coupling)+".png").c_str(),"pdf");
  ...
  canvas->SaveAs((outputDIR+"/scan_scalar_1D_dmMass_"+to_string(dmMass)+"_g"+string(coupling)+"_log.pdf").c_str(),"pdf");
  canvas->SaveAs((outputDIR+"/scan_scalar_1D_dmMass_"+to_string(dmMass)+"_g"+string(coupling)+"_log.png").c_str(),"pdf");
}
