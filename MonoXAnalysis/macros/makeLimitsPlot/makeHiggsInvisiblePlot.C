...
void makeHiggsInvisiblePlot(){
  ...
  limitValueExpected->SetPoint(0,0.5,0.8477);  
  limitValueExpected->SetPoint(1,1.5,0.7207);
  limitValueExpected->SetPoint(2,2.5,0.5645);
  ...
  limitValueObserved->SetPoint(2,2.5,0.4371);
  ...
  limitErr_1s->SetPoint(0,0.5,0.8477);
  limitErr_1s->SetPoint(1,1.5,0.7207);
  limitErr_1s->SetPoint(2,2.5,0.5645);
  limitErr_1s->SetPointError(0,0.5,0.5,fabs(0.8477-0.5842),fabs(0.8477-1.2666));
  limitErr_1s->SetPointError(1,0.5,0.5,fabs(0.7207-0.5144),fabs(0.7207-1.0223));
  limitErr_1s->SetPointError(2,0.5,0.5,fabs(0.5645-0.3994),fabs(0.5645-0.8052));

  TGraphAsymmErrors* limitErr_2s = new TGraphAsymmErrors();
  limitErr_2s->SetPoint(0,0.5,0.8477);
  limitErr_2s->SetPoint(1,1.5,0.7207);
  limitErr_2s->SetPoint(2,2.5,0.5645);
  limitErr_2s->SetPointError(0,0.5,0.5,fabs(0.8477-0.4188),fabs(0.8477-1.8555));
  limitErr_2s->SetPointError(1,0.5,0.5,fabs(0.7207-0.3843),fabs(0.7207-1.3923));
  limitErr_2s->SetPointError(2,0.5,0.5,fabs(0.5645-0.2988),fabs(0.5645-1.1078));

  TH1* frame = (TH1*) canvas->DrawFrame(0.,0.,3,2.5);
  frame->SetBins(3,0,3);
