...
void makeHiggsInvisiblePlotNoVBF(bool blind = false){
  ...
  limitValueExpected->SetPoint(0,0.5,0.5566);
  limitValueExpected->SetPoint(1,1.5,0.5684);  
  limitValueExpected->SetPoint(2,2.5,0.4043);
  ...
  limitValueObserved->SetPoint(0,0.5,0.5566);
  limitValueObserved->SetPoint(1,1.5,1.1692);
  limitValueObserved->SetPoint(2,2.5,0.4043);
  ...
  limitErr_1s->SetPoint(0,0.5,0.5566);
  limitErr_1s->SetPoint(1,1.5,0.5684);
  limitErr_1s->SetPoint(2,2.5,0.4043);
  limitErr_1s->SetPointError(0,0.5,0.5,fabs(0.5566-0.3980),fabs(0.5566-0.7852));
  limitErr_1s->SetPointError(1,0.5,0.5,fabs(0.5684-0.3903),fabs(0.5684-0.8561));
  limitErr_1s->SetPointError(2,0.5,0.5,fabs(0.4043-0.2861),fabs(0.4043-0.5767));

  TGraphAsymmErrors* limitErr_2s = new TGraphAsymmErrors();
  limitErr_2s->SetPoint(0,0.5,0.5566);
  limitErr_2s->SetPoint(1,1.5,0.5684);
  limitErr_2s->SetPoint(2,2.5,0.4043);
  limitErr_2s->SetPointError(0,0.5,0.5,fabs(0.5566-0.2976),fabs(0.5566-1.0652));
  limitErr_2s->SetPointError(1,0.5,0.5,fabs(0.5684-0.2853),fabs(0.5684-1.2683));
  limitErr_2s->SetPointError(2,0.5,0.5,fabs(0.4043-0.2140),fabs(0.4043-0.7934));
  ...
  frame->GetXaxis()->SetBinLabel(3,"Combination");
