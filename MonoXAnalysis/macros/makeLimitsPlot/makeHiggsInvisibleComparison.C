...
void makeHiggsInvisibleComparison(){
  ...
  limitErr_2s->SetPointError(2,0.5,0.5,fabs(0.9610-0.4916),fabs(0.9610-2.0813));
  limitErr_2s->SetPointError(3,0.5,0.5,fabs(1.0273-0.5197),fabs(1.0273-2.2489));
  limitErr_2s->SetPointError(4,0.5,0.5,fabs(0.9570-0.4916),fabs(0.9570-2.0697));
