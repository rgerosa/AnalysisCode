...
void prepostWE(string fitFilename, string templateFileName, string observable) {
  ...
  gROOT->SetBatch(kTRUE);
    ...
    TH1* tthist = (TH1*)pfile->Get("shapes_fit_b/ch6/Top_WE");
    ...
    leg->AddEntry(prhist, "Pre-fit W(e#nu)","L");
    leg->AddEntry(pohist, "Post-fit W(e#nu)","L");
