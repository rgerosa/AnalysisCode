...
void prepostZM(string fitFilename, string templateFileName, string observable) {
  ...
  gROOT->SetBatch(kTRUE);
    ...
    TH1* tthist = (TH1*)pfile->Get("shapes_fit_b/ch2/Top_ZM");
    ...
    leg->AddEntry(prhist, "Pre-fit Z(#mu#mu)","L");
    leg->AddEntry(pohist, "Post-fit Z(#mu#mu)","L");
