...
void showPlots() {
  ...
  plot(Sample::zmm, "nvtx"         , ""       , "N_{PV}"        , "Events", "outputPlots","zmm_nvtx"  , 0.218, 25, 5.5, 30.5, 0.05, 1e5,true);
  plot(Sample::zmm, "t1mumet"      , ""       , "Recoil [GeV]"        , "Events", "outputPlots","zmm_t1recoil"  , 0.218, 25, 0, 400, 0.05, 1e5,true);
  plot(Sample::zmm, "t1pfmet"      , ""       , "Met [GeV]"           , "Events", "outputPlots","zmm_t1met"  ,    0.218, 25, 0, 150, 0.05, 1e5,true);
  plot(Sample::zmm, "pfmet"        , ""       , "Raw Met [GeV]"       , "Events", "outputPlots","zmm_met",        0.218, 25, 0, 150, 0.05, 1e5,true);
  plot(Sample::zmm, "pfmethadronHF", ""       , "Met hadron HF [GeV]" , "Events", "outputPlots","zmm_met_hadronHF"  ,   0.218, 25, 0, 150, 0.05, 1e5,true);
  plot(Sample::zmm, "pfmetegammaHF", ""       , "Met Egamma HF [GeV]"     , "Events", "outputPlots","zmm_met_egammaHF", 0.218, 20, 0, 50, 0.05, 1e5,true);
  plot(Sample::zmm, "pfmetchargedhadron", ""  , "Met Charge Hadron [GeV]" , "Events", "outputPlots","zmm_met_chargeHadron",  0.218, 25, 0, 150, 0.05, 1e5,true);
  plot(Sample::zmm, "pfmetneutralhadron", ""  , "Met Neutral Hadron [GeV]", "Events", "outputPlots","zmm_met_neutralHadron", 0.218, 25, 0, 120, 0.05, 1e5,true);
  plot(Sample::zmm, "pfmetelectrons", ""      , "Met Electrons [GeV]"     , "Events", "outputPlots","zmm_met_electrons", 0.218, 20, 0, 100, 0.05, 1e5,true);
  plot(Sample::zmm, "pfmetmuons"    , ""      , "Met Muons [GeV]"         , "Events", "outputPlots","zmm_met_muons",     0.218, 25, 0, 150, 0.05, 1e5,true);
  plot(Sample::zmm, "pfmetphotons"  , ""      , "Met Photons [GeV]"       , "Events", "outputPlots","zmm_met_photons",   0.218, 25, 0, 150, 0.05, 1e5,true);

  plot(Sample::zee, "nvtx"         , ""       , "N_{PV}"        , "Events", "outputPlots","zee_nvtx"  , 0.218, 25, 5.5, 30.5, 0.05, 1e5,true);
  plot(Sample::zee, "t1elmet"      , ""       , "Recoil [GeV]"        , "Events", "outputPlots","zee_t1recoil"  , 0.218, 25, 0, 400, 0.05, 1e5,true);
