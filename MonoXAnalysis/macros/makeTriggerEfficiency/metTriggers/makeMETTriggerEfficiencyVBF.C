...
// recoil binning
vector <float> bins_vbf_recoil  = {100., 110., 120., 130., 140., 150., 160., 180., 200., 250., 300., 350., 400., 450., 500., 550., 650., 800., 1000., 1500};
// mjj
vector <float> bins_vbf_mjj     = {200.,600,1000.,1500.,2000.,2500.4000};
// pt-j1
vector <float> bins_vbf_ptj1    = {80,175,250,350,450,600};
// pt-j2
vector <float> bins_vbf_ptj2    = {40,80,130,200,350};
