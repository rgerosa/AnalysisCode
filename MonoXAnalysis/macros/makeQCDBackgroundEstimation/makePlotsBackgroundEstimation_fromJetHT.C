...
////////////----------
void makePlotsBackgroundEstimation(string inputFileName, string outputDIR, bool plotEstimationInSR = false){
  ...
  TH1F* dataRegion_C = (TH1F*) inputFile->Get("Data/histo_Data_mjj_regionC");
  ...
  TH1F* wjetsRegion_C = (TH1F*) inputFile->Get("WJets_MC/histo_WJets_mjj_regionC");
  ...
  TH1F* zjetsRegion_C = (TH1F*) inputFile->Get("ZJets_MC/histo_ZJets_mjj_regionC");

  dataRegion_C->Add(wjetsRegion_C,-1);
  dataRegion_C->Add(zjetsRegion_C,-1);
